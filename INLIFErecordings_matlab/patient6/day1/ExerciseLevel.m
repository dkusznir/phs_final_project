...
%% x-Axis
xlim([1,length(x)]);
name = {'9:00PM','1:00AM','5:00AM','9:00AM','1:00PM','5:00PM','9:00PM'};
step = fix(length(X)/6);
kk = 1:7;
value = [1,kk*step];
...
title('Patient6 10/24/2016-10/25/2016 Record','FontSize',15);
%%-------------------------------------------------------------------------
